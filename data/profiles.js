...
const srantoSoumik= {
    ...
    about: `Soumik Hasan Shranto is the Chief Strategy Officer and Founder of roboway technologies. Each of us has a memory of sketching and writing notes in the back pages of our notebooks. Shranto used those ideas from the back page to take the lead on initiatives and Platforms from school life. he began his startup journey in 2016 as a student with the idea of developing a platform for students where they could learn and make money using an app. That time he start his business, Yashmik & MiKhouse Designs, worked as events vendors, provided services to organizations, institutions, businesses. He led events and the college authority's initiatives at his college. In his college days, he worked with local businesses on a freelance basis to understand technological gaps in the offline market. That time, he began working in the tech supply chain. In local market was lacking in engineering tools, he established a business that provides tools . He purchases tools tough sites in China. He founded the rapid prototyping business Justdot3D in 2020. He provides 3D printing services to companies like Amarsource, EXENXNO, ANTS Aerial Systems and projects like IUT Mars Rover and other clubs and Organizations. One of the notable project in 3D printing sector was manual gearboxes for rickshaws. He begins working part-time in startups after completing HSC in 2021 to learn from founders who have vast knowledge of the industry. He has always thought that technology will change people's lives and give them the opportunity to use it to earn more money and learn more. He joined Onnesok as the Strategy and Business Lead to establishing a culture of innovation. Onnesok is working in bionic technology based innovation and making 4IR-based robots for industrial use. In terms of changing the ecosystem and create a technological hub in Bangladesh similar to Shenzhen, he spent time and build connection in our technological business' distribution hubs like Nawabpur, Patuatuli.He met another founder and co-founders through them on his journey. All share the same goal of developing a venture for a robotics-based solution and bringing it into everyone's life. The journey with Roboway began with a great vision to establish a robotics industry in Bangladesh where we will create solutions and provide local robotics enthusiasts with opportunities to work in robotics in Bangladesh and utilize their skills to solve problems.`
}
const ratulHasan = {
    name: "Ratul Hasan",
